...
func (t Training) Calories() float64 {
	// вставьте ваш код ниже
	return 0
	//(float64(CaloriesMeanSpeedMultiplier)*t.meanSpeed() + CaloriesMeanSpeedShift) * t.Weight / float64(MInKm) * float64(t.Duration) * float64(MinInHours)
}
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / float64(MInKm) * r.Duration.Hours())
}
...
func ReadData(training CaloriesCalculator) string {
	...
	//calories := training.TrainingInfo()
